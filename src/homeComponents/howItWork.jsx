    ...
    className="how_it-work w-[90%] mx-auto text-center mt-28 mb-6">
     ...
     <small className="text-lg text-[#6fb1fc] font-medium pb-1 block">work flow</small>
      ...
      <div className="how-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-10">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold mb-6  text-white bg-[hsl(246,92%,71%)] w-20 h-20 grid place-items-center  mx-auto shadow-md shadow-zinc-600">01</h1>
        ...
        <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-6  text-white bg-[hsl(246,92%,71%)] w-20 h-20 grid place-items-center  mx-auto shadow-md shadow-zinc-600">02</h1>
          <h3 className="text-3xl font-medium pb-3 text-[black] capitalize">meet your agent</h3>
          <p className="leading-[2rem] text-xl text-[black]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil amet voluptates perspiciatis. Aspernatur, rem obcaecati. Reprehenderit </p>
        </div>
        <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-6  text-white bg-[hsl(246,92%,71%)] w-20 h-20 grid place-items-center  mx-auto shadow-md shadow-zinc-600">03</h1>
          <h3 className="text-3xl font-medium pb-3 text-[black] capitalize">close the deal</h3>
          <p className="leading-[2rem] text-xl text-[black]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil amet voluptates perspiciatis. Aspernatur, rem obcaecati. Reprehenderit</p>
        </div>

        <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-6  text-white bg-[hsl(246,92%,71%)] w-20 h-20 grid place-items-center  mx-auto shadow-md shadow-zinc-600">04</h1>
