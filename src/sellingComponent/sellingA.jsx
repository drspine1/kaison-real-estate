...
const SellingA = () => {
  return (
    <>
      <div className="selling-a_component  w-full text-center mx-auto mt-28">
     <motion.div
     ...
     >
     <h1 className="capitalize text-2xl font-semibold text-[#251d1d]"><Link to="/" className="uppercase ">home</Link> : ready to sell?</h1>
    <div className="background  bg-indigo-200 w-32   mx-auto h-1 mt-3 mb-24"></div>
      ...
      <div className="right-img-buy flex-[60%]">
         <img src="/images/est8.jpg" alt=""  className="w-full h-full"/>
      </div>
      ...
      >
      <h1 className="text-left text-3xl capitalize text-white leading-snug pb-6">why sell with us</h1>
